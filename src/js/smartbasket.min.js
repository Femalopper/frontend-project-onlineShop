      ...
      (e = {
            ...
            complete: function (s) {
              ...
              e.commonResult(r, "", "submitEvent"),
                ...
                Swal.fire({
                  position: "center",
                  icon: "success",
                  title: "Заказ принят. Ожидайте звонка",
                  showConfirmButton: false,
                  timer: 1500,
                });
              setTimeout(() => {
                t("html").css("overflow-y", "scroll");
              }, 1.5e3),
                setTimeout(() => {
                  (r = e.getProducts() || {}),
                    e.commonResult(r, "updateCommonResult"),
        ...
        alertBlock: function (a) {
          ...
          l.click(function () {
            ...
            $("body").removeClass("blind_LayerWidth");
            t(this)
              .parents("." + s.attr("class"))
              .remove();
          }),
          ...
          return (
            ...
            (document.body.style.top = `-${document.documentElement.style.getPropertyValue(
              "--scroll-y"
            )}`),
            $("body").addClass("blind_LayerWidth"),
